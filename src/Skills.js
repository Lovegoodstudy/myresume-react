...
class Skills extends Component {
    render() {
        let styles = {
            background : {
                backgroundColor: this.props.muiTheme.palette.skillsBackgroundColor,
                paddingTop : '60px',
                paddingBottom : '60px',
                color: this.props.muiTheme.palette.skillsTextColor
            }
        };
        return(
            <div className="Block" style={styles.background} id="Skills">
...
export default muiThemeable()(Skills)